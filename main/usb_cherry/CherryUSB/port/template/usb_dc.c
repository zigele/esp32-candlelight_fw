...
int IRAM_ATTR usbd_ep_start_write(const uint8_t ep, const uint8_t *data, uint32_t data_len)
{
...
int IRAM_ATTR usbd_ep_start_read(const uint8_t ep, uint8_t *data, uint32_t data_len)
{
    uint8_t ep_idx = USB_EP_GET_IDX(ep);
